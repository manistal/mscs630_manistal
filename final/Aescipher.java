...
public class Aescipher {
  ...
  public static String generateCipher(String[][] masterKey, String[][] masterText, int column_size, int row_size, int rounds) {
  ...
  public static String generateWMatrix(int col_valueforInput, int column_size, int rounds) { 
    ...
    for (int column = col_valueforInput; column < column_size; column++) {
      ...
      // Every column for 256 bit encryption that isnt a new round
      ...
      // If this isn't 256 bit AES, we dont throw in an extra sbox
      ...
      // New Key Round Started, we just filled in a 4x4
